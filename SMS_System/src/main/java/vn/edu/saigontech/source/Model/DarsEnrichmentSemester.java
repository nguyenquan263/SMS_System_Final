...
/** This class represents the semesters in which the student studied enrichment courses
 * @author Nguyen Bao Hoang Long
 * Written on 22/3/2018
 */
public class DarsEnrichmentSemester {
	private String semester_name;
	private String acaYear;
	private String semester;
	private String num_semester_year;
	
	public DarsEnrichmentSemester(String semester_name, String acaYear, String semester, String num_semester_year) {
		super();

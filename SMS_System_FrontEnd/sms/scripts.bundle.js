...
// Link of big logo file (side bar not minimized)
var bigLogo = '<a href="#"><img src="assets/img/logo3.png" style="width:85%" /></a>';
// Link of small logo file (side bar not minimized)
var smallLogo = '<a href="#"><img src="assets/img/logo3mini.png" style="width:55%" class="ml-3" /></a>';
...
lbd = {
    ...
    initMinimizeSidebar: function () {
        ...
        // when we are on a Desktop Screen and the collapse is triggered we check
        // if the sidebar mini is active or not. If it is active then we don't let the collapse to show 
        //the elements because the elements from the collapse are showing on the hover state over the icons in sidebar mini, not on the click.
        ...
        $('#minimizeSidebar').click(function () {
            ...
            //Hover function for sidebar
            if (lbd.misc.sidebar_mini_active == true) {
                $('body').removeClass('sidebar-mini');
                lbd.misc.sidebar_mini_active = false;
                $(".logo").html(bigLogo);
                $(".sidebar-wrapper").css("overflow", "auto");
                if (isWindows) {
                ...
                $(".sidebar").hover(
                    function () {
                        if (lbd.misc.sidebar_mini_active == true && mobile_menu_visible == 0) {
                            $(".logo").html(bigLogo);
                            $(".sidebar-wrapper").css("overflow", "auto");
                        }
                    }, function () {
                        if (lbd.misc.sidebar_mini_active == true && mobile_menu_visible == 0) {
                            $(".logo").html(smallLogo);
                            $(".sidebar-wrapper").css("overflow", "visible");
                        }
                    }
                );

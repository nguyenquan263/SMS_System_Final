...
@Component({
  ...
  templateUrl: './enrichment-registration.component.html',
  styleUrls: ['./enrichment-registration.component.css'],
  providers: [CookieService,LoginService,ConnectionService,TimetableService]
})
export class EnrichmentRegistrationComponent implements OnInit {
